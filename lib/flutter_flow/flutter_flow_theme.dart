...
abstract class FlutterFlowTheme {
  ...
  late Color backgroundSignup;
  late Color textfieldColor;
  late Color iConColor;
  late Color gradientColorbutton1;
  late Color gradientColorbutton2;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5A4AF0);
  late Color secondary = const Color(0xFFF76061);
  ...
  late Color backgroundSignup = Color(0xFF181818);
  late Color textfieldColor = Color(0xFF7D7B86);
  late Color iConColor = Color(0xFFC1C6CE);
  late Color gradientColorbutton1 = Color(0xFF8176AF);
  late Color gradientColorbutton2 = Color(0xFFC0B7E8);
  late Color appBackgroundColor = Color(0xFF302C42);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4328F1);
  late Color secondary = const Color(0xFFF76061);
  late Color tertiary = const Color(0xFFFFA130);
  ...
  late Color secondaryBackground = const Color(0xFF1B1E25);
  late Color accent1 = const Color(0x4C19DB8A);
  late Color accent2 = const Color(0x4D36B4FF);
